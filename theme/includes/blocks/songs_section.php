<section class="songs-section">    
    ...
    <div class="songs-container">
        ...
        <div id="songs-list" style="display:none" class="songs-bottom">
            ...
            // Handle password validation (removed email handling)
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                $enteredPassword = $_POST['password'] ?? '';

                if ($enteredPassword === SONG_PASSWORD) {
                    echo '<script>document.getElementById("songs-list").style.display = "block";</script>';
                } else {
                ...
                while ($the_query->have_posts()) {
                    ...
                    <tr>
                        <td class="song-controls">
                            <button class="prev-btn" onclick="prevSong()">⏮</button>
                            <button class="play-pause-btn" data-song="<?php echo esc_url($song_mp3_file); ?>">▶️</button>
                        ...
                        <td class="act">
                            ...
                            <a href="<?php echo esc_url($song_mp3_file); ?>" download class="download-btn"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
